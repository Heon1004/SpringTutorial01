...
public class Program {
	...
	public static void main(String[] args) {
		...
		/*
			실행결과 Before Advice Logictotal target is NewlecExam [kor=10, eng=20, math=30,
			com=40] object is [Ljava.lang.Object;@3e11f9e9 returnValue : 100, method : total
			1ms 시간이 걸렸습니다. 
			total is 100
			  
			Before Advice Logicavg target is NewlecExam [kor=10, eng=20, math=30, com=40]
			object is [Ljava.lang.Object;@3012646b returnValue : 25.0, method : avg
			3ms 시간이 걸렸습니다. 
			total is 25.000000
		 
		
			앞에서 실행될 로직 total, target is NewlecExam [kor=100, eng=20, math=30, com=40]
			returnValue : 190, method : total
			Aroundadvice Logic
			1ms 시간이 걸렸습니다.
			total is 190
			
			returnValue : 47.5, method : avg
			total is 47.500000
		 */  
		...
		*/
		/*
			 Exam exam = new NewlecExam(1,1,1,1);
		 	 ...
		 	 //Object형으로 반환하기때문에 형식에 맞게 형변환 함 
		 	 Exam proxy = (Exam) Proxy.newProxyInstance(NewlecExam.class.getClassLoader(), 
			 new Class[] {Exam.class}, 
		 	 new InvocationHandler() {
			 
			 @Override 
			 //invoke는 모든 형태의 값을 반환하기위해 Object형으로 반환함 public Object
